"""In-memory fake Docker engine for unit tests."""
...
class FakeDockerEngine:
    ...
    def exec_run(
        ...
        *,
        ...
        if self._block_exec is not None:
            # Wait until released or timeout window elapses.
    ...
    def get_archive(self, container_id: str, path: str) -> bytes:
        ...
        if not matches:
            # Treat exact missing path as empty file for directory roots used in tests.
