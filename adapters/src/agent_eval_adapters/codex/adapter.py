"""OpenAI Codex CLI production Adapter — translation only."""
...
class CodexAdapter(BaseAdapter):
    """Observes OpenAI Codex CLI NDJSON output inside a Sandbox."""
    ...
    extra_args: tuple[str, ...] = ("exec", "--json")
    ...
    def prepare(self, context: ExecutionContext) -> None:
        if not context.prompt.strip() and self.stream_source is None:
            raise AdapterInitializationError(
                "Prompt content is required for Codex",
