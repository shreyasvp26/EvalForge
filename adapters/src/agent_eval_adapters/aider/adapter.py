"""Aider production Adapter — translation only."""
...
class AiderAdapter(BaseAdapter):
    """Observes Aider NDJSON output inside a Sandbox."""
    ...
    cli_binary: str = "aider"
    extra_args: tuple[str, ...] = ("--yes", "--no-gitignore")
    ...
    def prepare(self, context: ExecutionContext) -> None:
        if not context.prompt.strip() and self.stream_source is None:
            raise AdapterInitializationError(
                "Prompt content is required for Aider",
