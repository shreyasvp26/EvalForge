  ...
  function onSubmit(event: React.SyntheticEvent<HTMLFormElement>) {
    ...
    const idempotencyKey =
      typeof crypto !== "undefined" && "randomUUID" in crypto
        ? crypto.randomUUID()
        : `create-project-${String(Date.now())}`;
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Projects group suites, cases, agents, and runs for a workspace.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={onSubmit} className="space-y-4" noValidate>
          ...
          <div className="space-y-1.5">
            ...
            />
            {fieldErrors.name ? (
              <InlineError id={`${nameId}-error`}>{fieldErrors.name}</InlineError>
            ) : null}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {fieldErrors.description ? (
              <InlineError id={`${descriptionId}-error`}>{fieldErrors.description}</InlineError>
            ) : null}
          </div>
